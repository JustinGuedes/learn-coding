        ...
        <div className="mainContent">
          ...
          <section className="Mutability">
            ...
            <p>
              ...
              Always default to a immutable (constant) until you are required to
              change the value, then change it to a mutable ('variable')
              variable.
            </p>
            ...
            <pre>
              ...
              <Syntax color="blue">=</Syntax> <Syntax color="blue">3.14</Syntax>
            </pre>
          </section>
          ...
          <section className="Naming">
            <div>
              ...
              <div>
                <ul>
                  <li>
                    Unique and descriptive to be able to identifier the purpose
                    of the variable easily.
                  </li>
                  <li>
